 ...
 * {@link SeriesFragment.OnSeriesFragmentInteractionListener} interface
...
public class SeriesFragment extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onSeriesFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnSeriesFragmentInteractionListener) {
            mListener = (OnSeriesFragmentInteractionListener) context;
        } else {
    ...
    public interface OnSeriesFragmentInteractionListener {
        ...
        void onSeriesFragmentInteraction(Uri uri);
    }
}
